...
export function Pricing() {
  ...
  return (
    <section id="preise" className="relative py-24 sm:py-32 bg-white overflow-hidden">
        ...
        >
          <div className="rounded-3xl bg-white border border-gray-100 shadow-xl shadow-black/5 overflow-hidden">
            ...
            <div className="grid grid-cols-4 bg-[#0d4f4f] text-white">
              ...
              <div className="px-4 sm:px-6 py-5 text-center font-extrabold text-sm sm:text-base relative">
                60 Min
                <span className="absolute -top-2 right-2 sm:right-4 bg-[#f2a93b] text-[10px] font-bold px-2 py-0.5 rounded-full text-[#111]">
                  Beliebt
                </span>
              </div>
            </div>
          ...
          >
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-[#555] leading-relaxed">
                ...
                ich Sie zu Ihren Möglichkeiten.
              </p>
            </div>
          </motion.div>
